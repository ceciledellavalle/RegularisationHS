...
% Crenel
\def\datacurve{../data/pred0.51kernel.txt}
\def\datacurvenoise{../data/pred0.52kernel.txt}
...
\begin{axis}[
				 ...
				 % Title options
				 % ==================
				 title =  {\Large $x_{\delta,\alpha,p}$,  $a=0.5$,  kernel},
				 % ==================
				 % Legend options
				 % ==================
				 legend style = {
		...
		\addlegendentry{$p=1$} 
 		...
 		\addplot[
				 ...
				 % ==================
		 		 cyan,
		 		 line width = 1. 5pt,
				 style = dashed,% <solid>, <dashed>, <dotted>, <dashdotted>, more in documentation p. 181
				 % ==================
				 % Mark options
				 % ==================
