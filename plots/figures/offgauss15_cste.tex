...
% Crenel
\def\datacurve{../data/offgauss1.5.txt}
\def\datacurvenoise{../data/pred1.52.txt}
\def\datacurvenoisecste{../data/pred1.52_cste.txt}
		...
		\addlegendentry{$x$} 
 		...
 		\addplot[
				 ...
				 % ==================
		 		 blue,
		 		 line width = 1. 5pt,
				 style = dotted,% <solid>, <dashed>, <dotted>, <dashdotted>, more in documentation p. 181
				 % ==================
				 % Mark options
				 % ==================
